            ...
            <div className=" flex flex-col bg-background p-20 rounded-[3em]  space-y-4">
                ...
                <div className="w-full flex-col gap-5 flex md:flex-row">
                    <article className="min-w-[16rem] hover:scale-105 duration-200 transition-all p-6 w-full h-fit rounded-[2em] bg-cp-lightwhite flex flex-col items-center gap-10 justify-between">
                        ...
                        <div>
                        <h3 className="text-4xl">SOCIÁLNÍ</h3>
                        <h3 className="text-4xl">SÍTĚ</h3>
                        </div>
                        <Link href={"/socialni-site"} className="w-full">
                    ...
                    <article className="min-w-[16rem] hover:scale-105 duration-200 transition-all p-6 w-full rounded-[2em] bg-cp-lightwhite flex flex-col gap-10 justify-between">
                        <Image src={"/logos/star.svg"} alt="Logo Disoa marketing" className="mx-auto mt-5" width={84} height={84}/>
                        <h3 className="text-4xl text-center mb-11 text-nowrap">META ADS</h3>
                        <Link href={"/metaads"}>
                        <Button className="w-full flex flex-row justify-end"><ArrowDownRight className="size-16" strokeWidth={1}/></Button>
                        </Link>
                    </article>
