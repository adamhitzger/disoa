    ...
    return(
         <section id="karty" className={`w-full  flex flex-col justify-center p-4 items-center`}>
            <div className="max-w-4xl flex flex-col py-16 rounded-xl space-y-4">
                <div className="w-full grid gap-8 grid-cols-1 sm:grid-cols-3">
...
<span className="text-4xl  font-gothic font-light [word-spacing:0.2px] md:text-nowrap">{`${items[0].text}`}</span>
        </div>
...
<span className="text-4xl  font-gothic font-light [word-spacing:0.2px] md:text-nowrap">{`${items[1].text}`}</span>
        </div>
        <p className={`font-gothic leading-5.5 text-lg font-extralight `}>
          {items[1].endText}
        </p>
...
<span className="text-4xl  font-gothic font-light [word-spacing:0.2px] md:text-nowrap">{`${items[2].text}`}</span>
        </div>
        <p className={`font-gothic  leading-5.5 text-lg font-extralight `}>
          {items[2].endText}
        </p>
