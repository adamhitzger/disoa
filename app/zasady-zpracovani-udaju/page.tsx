...
export default function SouhlasPage() {
    return(
        <main className="p-5">
            <h1 className="text-3xl font-bold text-center py-4">Souhlas se zpracováním osobních údajů pro marketingové účely</h1>
            <ul className="text-base list-disc px-4">Fyzická osoba Jakub Doležal se sídlem Šmolovy 223, 58001 Havlíčkův Brod, identifikační číslo: 21349533, (dále jen „správce“), ve smyslu nařízení Evropského parlamentu a Rady EU 2016/679 zpracovávala tyto osobní údaje:
                <li>Jméno a příjmení,</li>
                <li>e-mail (dále jen „osobní údaje“)</li>
            </ul>
            <ol className="list-decimal px-8 text-base">
            <li>Fyzická osoba Jakub Doležal informuje své zákazníky, že mají právo:
                <ul>
