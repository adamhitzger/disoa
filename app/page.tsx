...
<h1 className="text-4xl font-medium">Web v rekonstrukci - tvoříme něco lepšího.</h1>
      <p className="text-gray-500 text-[17px] leading-8">
       Právě pro vás připravujeme nový digitální prostor, který bude stejně funkční a kreativní jako naše práce pro klienty.<br/>
       Jsme DISOA - marketingová agentura, která firmám pomáhá růst díky strategii, obsahu a výkonu.<br/>
        Mezitím nás můžete kontaktovat na e-mailu <Link className="text-blue-800 " href={"mailto:info@disoa.cz"}>info@disoa.cz</Link> nebo sledovat naší práci na sociálních sítích.<br/>
